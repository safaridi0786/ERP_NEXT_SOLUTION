...
function PartialBill() {
  ...
  const columns = [
    ...
    {
      field: "TOTAL_PAID_BILL",
      headerName: "TOTAL PAID BILL",
      flex: 1,
      // type: "number",
      // width: 110,
      sortable: false,
  ...
  return (
    <>
      <Box sx={{ p: 2, display: "flex", flexDirection: "column", gap: 2 }}>
        <Grid container spacing={2}>
          ...
          >
            ...
            >
              <AddCircleIcon /> Add Partial Bill
            </Button>
          </Grid>
        </Grid>
        <Box sx={{ height: 400 }}>
      ...
      >
        ...
        >
          <Typography fontWeight={"bold"}>Add Partial Bill</Typography>
          <IconButton
            sx={{
              color: "white",
              p: "0",
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description" sx={{ p: 2 }}>
            <Typography>Add here</Typography>
          </DialogContentText>
        </DialogContent>
      ...
      >
        ...
        >
          <Typography fontWeight={"bold"}>Edit Partial Bill</Typography>
          <IconButton
            sx={{
              color: "white",
              p: "0",
      ...
      >
        ...
        <DialogContent>
          ...
          >
            ...
            >
              Do you want to delete this Partial Bill
              {/* <span
                    style={{
                      fontFamily: "Poppins",
                      fontWeight: "600",
