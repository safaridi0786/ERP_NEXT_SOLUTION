...
function FacilityDetail() {
  ...
  const columns = [
    ...
    {
      field: "IS_FACILITY_FOR_ATTENDENCE",
      headerName: "IS FACILITY FOR ATTENDENCE",
      flex: 1,
      // type: "number",
      // width: 110,
      sortable: false,
    ...
    {
      field: "IS_ATTENDENCE_BASE",
      headerName: "IS ATTENDENCE BASE",
      flex: 1,
      // type: "number",
      // width: 110,
      sortable: false,
    ...
    {
      field: "IS_MONTHLY_BASE",
      headerName: "IS MONTHLY BASE",
      flex: 1,
      // type: "number",
      // width: 110,
      sortable: false,
  ...
  const row = [
    {
      ...
      FACILITY_CODE: "3220",
      DESCRIPTION: "Snooker",
      FACILITY_RATE: "Snooker",
      GST: "Yes",
      IS_ACTIVE: "Yes",
      IS_FACILITY_FOR_ATTENDENCE: "No",
      IS_ATTENDENCE_BASE: "No",
      IS_DELETE: "Yes",
      IS_MONTHLY_BASE: "2023-04-77",
    },
  ];
  ...
  return (
    <>
      ...
      <Box sx={{ p: 2, display: "flex", flexDirection: "column", gap: 2 }}>
        <Grid container spacing={2}>
          ...
          >
            ...
            >
              <AddCircleIcon /> Add Facility Detail
            </Button>
          </Grid>
        </Grid>
        <Box sx={{ height: 400 }}>
      ...
      >
        ...
        >
          <Typography fontWeight={"bold"}>Add Facility Detail</Typography>
          <IconButton
            sx={{
              color: "white",
              p: "0",
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description" sx={{ p: 2 }}>
            ...
            <Box sx={{ p: 1, borderBottom: "2px solid black" }}>
              <Typography
                sx={{
                  fontWeight: "800",
                  fontSize: "14px",
      ...
      >
        ...
        >
          <Typography fontWeight={"bold"}>Edit Facility Detail</Typography>
          <IconButton
            sx={{
              color: "white",
              p: "0",
      ...
      >
        ...
        <DialogContent>
          ...
          >
            ...
            >
              Do you want to delete this Facility Detail
              {/* <span
            style={{
              fontFamily: "Poppins",
              fontWeight: "600",
